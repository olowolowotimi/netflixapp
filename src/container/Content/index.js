    ...
    <div>
      <div className={conStyle.sub}>
        ...
        <div className={conStyle.section}>
          <div className={conStyle.col}>
            <img
              src="/static/img/section2Image.jpg"
              className={conStyle.section2Image}
            />
            <div className={conStyle.downloadPopup}>
              <img
                className={conStyle.downloadBanner}
                src="/static/img/downloadMovieImage.png"
              />
              ...
              <img
                className={conStyle.downloadIcon}
                src="/static/img/download.gif"
              />
            </div>
          </div>
          <div className={conStyle.col}>
