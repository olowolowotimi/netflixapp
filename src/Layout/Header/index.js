...
const Header = () => {
    return (
        <div className={topStyle.main}>
            <div className={topStyle.mainContent}>
                <div className={topStyle.topNav}>
                    <svg viewBox="0 0 111 30" className={topStyle.netflixlogo} focusable="false">
                        <g>
                            <path
                    ...
                    <button className={`${topStyle.button} ${topStyle.topNavButton}`}>Sign In</button>
                </div>
                <div className={topStyle.welcomeBox}>
